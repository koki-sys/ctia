...
// html要素
const errorDisplayQR = document.getElementById('dicegame-qr');
...
const displayQR = async (roomData) => {
    if (limitPerRoom == 1 && roomCount == 1) {
        ...
        console.log("qr生成中")
        const ruleUrl = frontendUrl + "/html/dicegame/group/rule.html?";
