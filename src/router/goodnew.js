...
router.get("/group/qr_code_display", (req, res) =>
    res.render("group/qr_code_display", { accessTargetGameName }),
)
router.get("/group/game_rule_description", (req, res) =>
    res.render("group/game_rule_description", { accessTargetGameName }),
)
